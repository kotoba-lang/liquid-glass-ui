...
(deftest document-primitives-and-groups-match-form-a
  (let [radius (into (sorted-map) (get tokens/default-tokens :liquid-glass/radius))
        ...
        docs (compile-and-run
              document-source
              {"radius" (str "(render-group (group-doc (record-new [:ref :lgdoc/group] \"liquid-glass\" \"radius\" "
                             (entries-vector radius) ")))")
               "accent" (str "(render-group (group-doc (record-new [:ref :lgdoc/group] \"liquid-glass\" \"accent\" "
                             (entries-vector accent) ")))")
               "lens" (str "(render-group (group-doc (record-new [:ref :lgdoc/group] \"liquid-glass\" \"lens\" "
                           (entries-vector lens) ")))")
               "ink" (str "(render-group (group-doc (record-new [:ref :lgdoc/group] \"liquid-glass\" \"ink\" "
                          (entries-vector ink) ")))")
               "root" (str "(root-css (render-group (group-doc (record-new [:ref :lgdoc/group] \"liquid-glass\" \"ink\" "
                          "(document-vector (entry (record-new [:ref :lgdoc/entry] :default \"#1c1c1e\")))))))")
               "dark" (str "(dark-root-css (render-group (group-doc (record-new [:ref :lgdoc/group] \"liquid-glass\" \"ink\" "
                          "(document-vector (entry (record-new [:ref :lgdoc/entry] :default \"#f5f5f7\")))))))")
               "c_decl" (str "(render-group (group-doc (record-new [:ref :lgdoc/group] \"liquid-glass\" \"ink\" "
                            "(document-vector (entry (record-new [:ref :lgdoc/entry] :default \"#1c1c1e\"))))))")
               "n_decl" (str "(render-group (nested-doc (record-new [:ref :lgdoc/nested] \"liquid-glass\" \"surface\" \"regular\" "
...
(deftest document-nested-and-samples-match-form-a
  (let [regular (into (sorted-map)
        ...
        docs (compile-and-run
              document-source
              {"regular" (str "(render-group (nested-doc (record-new [:ref :lgdoc/nested] \"liquid-glass\" \"surface\" \"regular\" "
                              (entries-vector regular) ")))")
               "press" (str "(render-group (nested-doc (record-new [:ref :lgdoc/nested] \"liquid-glass\" \"motion\" \"press\" "
